...
let getLogin  = (req,res)=>{
    page_parameters = {title: "login", page_title: "login", style: "/styles/stileLog.css"} 
    res.render("login",{page_parameters});
}
...
let addlogin = (req,res)=>{
    page_parameters = {title: "login", page_title: "login", style: "/styles/stileLog.css"}
    const {loginUsername, loginPassword} = req.body;
    const loginform = Loginform({loginUsername, loginPassword})
    loginform.save()
    .then((result)=>res.render("login",{page_parameters}))
    .catch((error)=>console.log(error));
}
